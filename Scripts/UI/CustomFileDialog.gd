...
func _ready() -> void:
	...
	_Fav.icon = load("res://Assets/star.svg")#get_icon("fav_icon", "CustomFileDialog")
	_Back.icon = load("res://Assets/back_arrow.svg")#get_icon("back_icon", "CustomFileDialog")
	_Forward.icon = load("res://Assets/forward_arrow.svg")#get_icon("forward_icon", "CustomFileDialog")
	_AddFolder.icon = load("res://Assets/add_folder.svg")#get_icon("add_folder_icon", "CustomFileDialog")

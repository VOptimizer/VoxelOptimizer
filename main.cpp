...
{
    auto loader = VoxelOptimizer::ILoader::CreateAndLoad("Deer_moved.qbcl");
    auto loader1 = VoxelOptimizer::ILoader::CreateAndLoad("Deer_moved_higher.qbcl");
    auto loader2 = VoxelOptimizer::ILoader::CreateAndLoad("NewModel2.qbcl");
    auto loader3 = VoxelOptimizer::ILoader::CreateAndLoad("NewModel3.qbcl");
